...
REM
REM Example: FullD25               -> will build Release, Win32
REM Example: FullD25 Debug         -> will build Debug, Win32
REM Example: FullD25 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD25
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD25%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\..\Output\D25\%IndyPlatform%\%IndyConfig%

if not exist ..\..\..\Output\D25\*.* md ..\..\..\Output\D25 > nul
if not exist ..\..\..\Output\D25\%IndyPlatform% md ..\..\..\Output\D25\%IndyPlatform% > nul
if not exist ..\..\..\Output\D25\%IndyPlatform%\%IndyConfig% md ..\..\..\Output\D25\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\..\Output\D25\*.* call "%~dp0..\Clean.bat" ..\..\..\Output\D25\
...
:endnocompiler
echo Delphi 10.2 Tokyo Compiler Not Present!
goto endok
