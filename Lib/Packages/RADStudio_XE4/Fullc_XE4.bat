...
REM
REM Pre-requisites:  \Lib\Packages\RADStudio_XE4 contains the project / res files
...
copy IndySystem.dpk ..\..\..\C18 > nul
copy IndySystem.dproj ..\..\..\C18 > nul
copy *IndyCore.dpk ..\..\..\C18 > nul
copy *IndyCore.dproj ..\..\..\C18 > nul
copy *IndyProtocols.dpk ..\..\..\C18 > nul
copy *IndyProtocols.dproj ..\..\..\C18 > nul
