...
REM                  \Lib\Packages\RADStudio_2010 contains the project / res files
...
copy IndySystem.dpk ..\..\..\C14 > nul
copy *IndySystem.cfg1 ..\..\..\C14 > nul
copy *IndySystem.cfg2 ..\..\..\C14 > nul
copy *IndyCore.dpk ..\..\..\C14 > nul
copy *IndyCore.cfg1 ..\..\..\C14 > nul
copy *IndyCore.cfg2 ..\..\..\C14 > nul
copy *IndyProtocols.dpk ..\..\..\C14 > nul
copy *IndyProtocols.cfg1 ..\..\..\C14 > nul
copy *IndyProtocols.cfg2 ..\..\..\C14 > nul
...
%NDC14%\bin\dcc32.exe /B IndySystem.dpk
...
%NDC14%\bin\dcc32.exe /B IndyCore.dpk
if errorlevel 1 goto enderror2
...
%NDC14%\bin\dcc32.exe /B dclIndyCore.dpk
if errorlevel 1 goto enderror2
...
%NDC14%\bin\dcc32.exe /B IndyProtocols.dpk
if errorlevel 1 goto enderror2
...
%NDC14%\bin\dcc32.exe /B dclIndyProtocols.dpk
if errorlevel 1 goto enderror2
...
cd ..\Lib\Packages\RADStudio_2010
goto endok
