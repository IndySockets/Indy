...
REM ****************************************************************************
REM  C++Builder 6 build for Indy (packages relocated; source resolves via ..\..\Source).
REM  Build runs in the Output\C6 temp dir so the dpk's ..\..\Source paths resolve.
REM ****************************************************************************
...
copy ..\..\Source\Protocols\ZLib\*.obj ..\..\Output\C6 > nul
cd ..\..\Output\C6
...
%NDC6%\bin\dcc32.exe /B IndyProtocols.dpk
if errorlevel 1 goto enderror
..\..\LspFix.exe IndyProtocols60.lsp
...
REM ----- relocate finished artifacts up to the repo-root Output\C6 build folder -----
if not exist ..\..\..\Output\C6\*.* md ..\..\..\Output\C6 >nul
move /Y *.* ..\..\..\Output\C6\ >nul
