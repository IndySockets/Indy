...
REM
REM Example: FullD15               -> will build Release, Win32
REM Example: FullD15 Debug         -> will build Debug, Win32
REM Example: FullD15 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD15
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD15%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\..\Output\D15\%IndyPlatform%\%IndyConfig%

if not exist ..\..\..\Output\D15\*.* md ..\..\..\Output\D15 > nul
if not exist ..\..\..\Output\D15\%IndyPlatform% md ..\..\..\Output\D15\%IndyPlatform% > nul
if not exist ..\..\..\Output\D15\%IndyPlatform%\%IndyConfig% md ..\..\..\Output\D15\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\..\Output\D15\*.* call "%~dp0..\Clean.bat" ..\..\..\Output\D15\
...
:endnocompiler
echo Delphi XE Compiler Not Present!
goto endok
