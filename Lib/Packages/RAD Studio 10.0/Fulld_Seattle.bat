...
REM
REM Example: FullD23               -> will build Release, Win32
REM Example: FullD23 Debug         -> will build Debug, Win32
REM Example: FullD23 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\..\Output\D23\%IndyPlatform%\%IndyConfig%

if not exist ..\..\..\Output\D23\*.* md ..\..\..\Output\D23 > nul
if not exist ..\..\..\Output\D23\%IndyPlatform% md ..\..\..\Output\D23\%IndyPlatform% > nul
if not exist ..\..\..\Output\D23\%IndyPlatform%\%IndyConfig% md ..\..\..\Output\D23\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\..\Output\D23\*.* call "%~dp0..\Clean.bat" ..\..\..\Output\D23\
...
:endnocompiler
echo Delphi 10 Seattle Compiler Not Present!
goto endok
