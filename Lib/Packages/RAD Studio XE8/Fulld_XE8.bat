...
REM
REM Example: FullD22               -> will build Release, Win32
REM Example: FullD22 Debug         -> will build Debug, Win32
REM Example: FullD22 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD22
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD22%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\..\Output\D22\%IndyPlatform%\%IndyConfig%

if not exist ..\..\..\Output\D22\*.* md ..\..\..\Output\D22 > nul
if not exist ..\..\..\Output\D22\%IndyPlatform% md ..\..\..\Output\D22\%IndyPlatform% > nul
if not exist ..\..\..\Output\D22\%IndyPlatform%\%IndyConfig% md ..\..\..\Output\D22\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\..\Output\D22\*.* call "%~dp0..\Clean.bat" ..\..\..\Output\D22\
...
:endnocompiler
echo Delphi XE8 Compiler Not Present!
goto endok
