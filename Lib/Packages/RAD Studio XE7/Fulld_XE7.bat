...
REM
REM Example: FullD21               -> will build Release, Win32
REM Example: FullD21 Debug         -> will build Debug, Win32
REM Example: FullD21 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD21
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD21%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\..\Output\D21\%IndyPlatform%\%IndyConfig%

if not exist ..\..\..\Output\D21\*.* md ..\..\..\Output\D21 > nul
if not exist ..\..\..\Output\D21\%IndyPlatform% md ..\..\..\Output\D21\%IndyPlatform% > nul
if not exist ..\..\..\Output\D21\%IndyPlatform%\%IndyConfig% md ..\..\..\Output\D21\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\..\Output\D21\*.* call "%~dp0..\Clean.bat" ..\..\..\Output\D21\
...
:endnocompiler
echo Delphi XE7 Compiler Not Present!
goto endok
