...
REM
REM Example: FullD17               -> will build Release, Win32
REM Example: FullD17 Debug         -> will build Debug, Win32
REM Example: FullD17 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD17
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD17%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\..\Output\D17\%IndyPlatform%\%IndyConfig%

if not exist ..\..\..\Output\D17\*.* md ..\..\..\Output\D17 > nul
if not exist ..\..\..\Output\D17\%IndyPlatform% md ..\..\..\Output\D17\%IndyPlatform% > nul
if not exist ..\..\..\Output\D17\%IndyPlatform%\%IndyConfig% md ..\..\..\Output\D17\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\..\Output\D17\*.* call "%~dp0..\Clean.bat" ..\..\..\Output\D17\
...
:endnocompiler
echo Delphi XE3 Compiler Not Present!
goto endok
