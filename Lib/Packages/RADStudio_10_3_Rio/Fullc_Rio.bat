...
:indysystem
cd System
copy IndySystem.dpk ..\..\C26 > nul
copy IndySystem.dproj ..\..\C26 > nul
copy *.res ..\..\C26 > nul
copy *.pas ..\..\C26 > nul
copy *.inc ..\..\C26 > nul
copy *.ico ..\..\C26 > nul
...
copy *IndyCore.dpk ..\..\C26 > nul
copy *IndyCore.dproj ..\..\C26 > nul
copy *.res ..\..\C26 > nul
copy *.pas ..\..\C26 > nul
copy *.dcr ..\..\C26 > nul
copy *.inc ..\..\C26 > nul
...
copy *IndyProtocols.dpk ..\..\C26 > nul
copy *IndyProtocols.dproj ..\..\C26 > nul
copy *.res ..\..\C26 > nul
copy *.pas ..\..\C26 > nul
copy *.dcr ..\..\C26 > nul
copy *.inc ..\..\C26 > nul
