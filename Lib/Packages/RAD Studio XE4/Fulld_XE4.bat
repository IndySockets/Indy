...
REM
REM Example: FullD18               -> will build Release, Win32
REM Example: FullD18 Debug         -> will build Debug, Win32
REM Example: FullD18 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD18
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD18%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\..\Output\D18\%IndyPlatform%\%IndyConfig%

if not exist ..\..\..\Output\D18\*.* md ..\..\..\Output\D18 > nul
if not exist ..\..\..\Output\D18\%IndyPlatform% md ..\..\..\Output\D18\%IndyPlatform% > nul
if not exist ..\..\..\Output\D18\%IndyPlatform%\%IndyConfig% md ..\..\..\Output\D18\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\..\Output\D18\*.* call "%~dp0..\Clean.bat" ..\..\..\Output\D18\
...
:endnocompiler
echo Delphi XE4 Compiler Not Present!
goto endok
