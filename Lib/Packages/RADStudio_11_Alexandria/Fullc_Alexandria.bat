...
REM
REM Pre-requisites:  \Lib\Packages\RADStudio_11_Alexandria contains the project / res files
...
copy IndySystem.dpk ..\..\..\C28 > nul
copy IndySystem.dproj ..\..\..\C28 > nul
copy *IndyCore.dpk ..\..\..\C28 > nul
copy *IndyCore.dproj ..\..\..\C28 > nul
copy *IndyProtocols.dpk ..\..\..\C28 > nul
copy *IndyProtocols.dproj ..\..\..\C28 > nul
...
cd ..\Lib\Packages\RADStudio_11_Alexandria
goto endok
