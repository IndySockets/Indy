...
REM
REM Example: FullD27               -> will build Release, Win32
REM Example: FullD27 Debug         -> will build Debug, Win32
REM Example: FullD27 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD27
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD27%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\..\Output\D27\%IndyPlatform%\%IndyConfig%

if not exist ..\..\..\Output\D27\*.* md ..\..\..\Output\D27 > nul
if not exist ..\..\..\Output\D27\%IndyPlatform% md ..\..\..\Output\D27\%IndyPlatform% > nul
if not exist ..\..\..\Output\D27\%IndyPlatform%\%IndyConfig% md ..\..\..\Output\D27\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\..\Output\D27\*.* call "%~dp0..\Clean.bat" ..\..\..\Output\D27\
...
:endnocompiler
echo Delphi 10.4 Sydney Compiler Not Present!
goto endok
