...
REM
REM Example: FullD28               -> will build Release, Win32
REM Example: FullD28 Debug         -> will build Debug, Win32
REM Example: FullD28 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD28
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD28%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\..\Output\D28\%IndyPlatform%\%IndyConfig%

if not exist ..\..\..\Output\D28\*.* md ..\..\..\Output\D28 > nul
if not exist ..\..\..\Output\D28\%IndyPlatform% md ..\..\..\Output\D28\%IndyPlatform% > nul
if not exist ..\..\..\Output\D28\%IndyPlatform%\%IndyConfig% md ..\..\..\Output\D28\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\..\Output\D28\*.* call "%~dp0..\Clean.bat" ..\..\..\Output\D28\
...
:endnocompiler
echo Delphi 11 Alexandria Compiler Not Present!
goto endok
