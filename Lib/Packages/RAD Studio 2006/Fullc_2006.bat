...
REM ****************************************************************************
REM  C++Builder 10 build for Indy (packages relocated; source resolves via ..\..\Source).
REM  Build runs in the Output\C10 temp dir so the dpk's ..\..\Source paths resolve.
REM ****************************************************************************
...
copy ..\..\Source\Protocols\ZLib\*.obj ..\..\Output\C10 > nul
cd ..\..\Output\C10
...
REM ----- relocate finished artifacts up to the repo-root Output\C10 build folder -----
if not exist ..\..\..\Output\C10\*.* md ..\..\..\Output\C10 >nul
move /Y *.* ..\..\..\Output\C10\ >nul
