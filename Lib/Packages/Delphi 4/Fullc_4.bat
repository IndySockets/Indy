...
REM ****************************************************************************
REM  C++Builder 4 build for Indy (packages relocated; source resolves via ..\..\Source).
REM  Build runs in the Output\C4 temp dir so the dpk's ..\..\Source paths resolve.
REM ****************************************************************************
...
copy ..\..\Source\Protocols\ZLib\*.obj ..\..\Output\C4 > nul
cd ..\..\Output\C4
...
%NDC4%\bin\dcc32.exe /B IndyProtocols40.dpk
if errorlevel 1 goto enderror
..\..\LspFix.exe IndyProtocols40.lsp
...
REM ----- relocate finished artifacts up to the repo-root Output\C4 build folder -----
if not exist ..\..\..\Output\C4\*.* md ..\..\..\Output\C4 >nul
move /Y *.* ..\..\..\Output\C4\ >nul
