...
//    crl_verify: function(crl: PX509_CRL, pk: PEVP_PKEY): TIdC_INT): PX509_CRL_METHOD;
  ...
  function X509_pubkey_digest(const data: PX509; const &type: PEVP_MD; md: PByte; len: PIdC_UINT): TIdC_INT cdecl; external CLibCrypto;
  function X509_digest(const data: PX509; const &type: PEVP_MD; md: PByte; len: PIdC_UINT): TIdC_INT cdecl; external CLibCrypto;
  function X509_CRL_digest(const data: PX509_CRL; const &type: PEVP_MD; md: PByte; len: PIdC_UINT): TIdC_INT cdecl; external CLibCrypto;
  function X509_REQ_digest(const data: PX509_REQ; const &type: PEVP_MD; md: PByte; len: PIdC_UINT): TIdC_INT cdecl; external CLibCrypto;
  function X509_NAME_digest(const data: PX509_NAME; const &type: PEVP_MD; md: PByte; len: PIdC_UINT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function d2i_X509_ALGOR(a: PPX509_ALGOR; const &in: PPByte; len: TIdC_LONG): PX509_ALGOR cdecl; external CLibCrypto;
  function i2d_X509_ALGOR(a: PX509_ALGOR; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
  ...
  function d2i_X509_VAL(a: PPX509_VAL; const &in: PPByte; len: TIdC_LONG): PX509_VAL cdecl; external CLibCrypto;
  function i2d_X509_VAL(a: PX509_VAL; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
  ...
  function d2i_X509_PUBKEY(a: PPX509_PUBKEY; const &in: PPByte; len: TIdC_LONG): PX509_PUBKEY cdecl; external CLibCrypto;
  function i2d_X509_PUBKEY(a: PX509_PUBKEY; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
...
//  function X509_get_pubkey_parameters(pkey: PEVP_PKEY; chain: P STACK_OF(X509)): TIdC_INT;
  ...
  function d2i_X509_SIG(a: PPX509_SIG; const &in: PPByte; len: TIdC_LONG): PX509_SIG cdecl; external CLibCrypto;
  function i2d_X509_SIG(a: PX509_SIG; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
  ...
  function d2i_X509_REQ_INFO(a: PPX509_REQ_INFO; const &in: PPByte; len: TIdC_LONG): PX509_REQ_INFO cdecl; external CLibCrypto;
  function i2d_X509_REQ_INFO(a: PX509_REQ_INFO; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;

  function X509_REQ_new: PX509_REQ cdecl; external CLibCrypto;
  procedure X509_REQ_free(v1: PX509_REQ) cdecl; external CLibCrypto;
  function d2i_X509_REQ(a: PPX509_REQ; const &in: PPByte; len: TIdC_LONG): PX509_REQ cdecl; external CLibCrypto;
  function i2d_X509_REQ(a: PX509_REQ; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
  ...
  function d2i_X509_ATTRIBUTE(a: PPX509_ATTRIBUTE; const &in: PPByte; len: TIdC_LONG): PX509_ATTRIBUTE cdecl; external CLibCrypto;
  function i2d_X509_ATTRIBUTE(a: PX509_ATTRIBUTE; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
  ...
  function d2i_X509_EXTENSION(a: PPX509_EXTENSION; const &in: PPByte; len: TIdC_LONG): PX509_EXTENSION cdecl; external CLibCrypto;
  function i2d_X509_EXTENSION(a: PX509_EXTENSION; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
  ...
  function d2i_X509_NAME_ENTRY(a: PPX509_NAME_ENTRY; const &in: PPByte; len: TIdC_LONG): PX509_NAME_ENTRY cdecl; external CLibCrypto;
  function i2d_X509_NAME_ENTRY(a: PX509_NAME_ENTRY; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
  ...
  function d2i_X509_NAME(a: PPX509_NAME; const &in: PPByte; len: TIdC_LONG): PX509_NAME cdecl; external CLibCrypto;
  function i2d_X509_NAME(a: PX509_NAME; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
  ...
  function d2i_X509(a: PPX509; const &in: PPByte; len: TIdC_LONG): PX509 cdecl; external CLibCrypto;
  function i2d_X509(a: PX509; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
...
//                                                                  TIdC_INT);
  ...
  function d2i_X509_REVOKED(a: PPX509_REVOKED; const &in: PPByte; len: TIdC_LONG): PX509_REVOKED cdecl; external CLibCrypto;
  function i2d_X509_REVOKED(a: PX509_REVOKED; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
  ...
  function d2i_X509_CRL_INFO(a: PPX509_CRL_INFO; const &in: PPByte; len: TIdC_LONG): PX509_CRL_INFO cdecl; external CLibCrypto;
  function i2d_X509_CRL_INFO(a: PX509_CRL_INFO; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
  function X509_CRL_new: PX509_CRL cdecl; external CLibCrypto;
  procedure X509_CRL_free(v1: PX509_CRL) cdecl; external CLibCrypto;
  function d2i_X509_CRL(a: PPX509_CRL; const &in: PPByte; len: TIdC_LONG): PX509_CRL cdecl; external CLibCrypto;
  function i2d_X509_CRL(a: PX509_CRL; &out: PPByte): TIdC_INT cdecl; external CLibCrypto;
...
//                char *data, EVP_PKEY *pkey, const EVP_MD *type);
  ...
  function ASN1_item_digest(const it: PASN1_ITEM; const &type: PEVP_MD; data: Pointer; md: PByte; len: PIdC_UINT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function ASN1_item_sign(const it: PASN1_ITEM; algor1: PX509_ALGOR; algor2: PX509_ALGOR; signature: PASN1_BIT_STRING; data: Pointer; pkey: PEVP_PKEY; const &type: PEVP_MD): TIdC_INT cdecl; external CLibCrypto;
...
//  STACK_OF(X509_EXTENSION) *X509_REQ_get_extensions(X509_REQ *req);
  ...
  function X509_REQ_add1_attr_by_OBJ(req: PX509_REQ; const obj: PASN1_OBJECT; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function X509_REQ_add1_attr_by_NID(req: PX509_REQ; nid: TIdC_INT; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function X509_REQ_add1_attr_by_txt(req: PX509_REQ; const attrname: PIdAnsiChar; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function X509_NAME_add_entry(name: PX509_NAME; const ne: PX509_NAME_ENTRY; loc: TIdC_INT; &set: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function X509_NAME_add_entry_by_OBJ(name: PX509_NAME; const obj: PASN1_OBJECT; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT; loc: TIdC_INT; &set: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function X509_NAME_add_entry_by_NID(name: PX509_NAME; nid: TIdC_INT; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT; loc: TIdC_INT; &set: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function X509_NAME_ENTRY_create_by_txt(ne: PPX509_NAME_ENTRY; const field: PIdAnsiChar; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): PX509_NAME_ENTRY cdecl; external CLibCrypto;
  function X509_NAME_ENTRY_create_by_NID(ne: PPX509_NAME_ENTRY; nid: TIdC_INT; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): PX509_NAME_ENTRY cdecl; external CLibCrypto;
  function X509_NAME_add_entry_by_txt(name: PX509_NAME; const field: PIdAnsiChar; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT; loc: TIdC_INT; &set: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function X509_NAME_ENTRY_create_by_OBJ(ne: PPX509_NAME_ENTRY; const obj: PASN1_OBJECT; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): PX509_NAME_ENTRY cdecl; external CLibCrypto;
  function X509_NAME_ENTRY_set_object(ne: PX509_NAME_ENTRY; const obj: PASN1_OBJECT): TIdC_INT cdecl; external CLibCrypto;
  function X509_NAME_ENTRY_set_data(ne: PX509_NAME_ENTRY; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function X509_ATTRIBUTE_create_by_txt(attr: PPX509_ATTRIBUTE; const atrname: PIdAnsiChar; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): PX509_ATTRIBUTE cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_add1_attr_by_OBJ(key: PEVP_PKEY; const obj: PASN1_OBJECT; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_add1_attr_by_NID(key: PEVP_PKEY; nid: TIdC_INT; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_add1_attr_by_txt(key: PEVP_PKEY; const attrname: PIdAnsiChar; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
...
//  X509 *X509_find_by_subject(STACK_OF(X509) *sk, X509_NAME *name);
  ...
  function PKCS8_pkey_add1_attr_by_NID(p8: PPKCS8_PRIV_KEY_INFO; nid: TIdC_INT; &type: TIdC_INT; const bytes: PByte; len: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
