...
type
  ...
  //function d2i_PKCS7_ISSUER_AND_SERIAL(a: PPPKCS7_ISSUER_AND_SERIAL; const &in: PByte; len: TIdC_LONG): PPKCS7_ISSUER_AND_SERIAL;
  //function i2d_PKCS7_ISSUER_AND_SERIAL(const a: PPKCS7_ISSUER_AND_SERIAL; &out: PByte): TIdC_INT;
  //function PKCS7_ISSUER_AND_SERIAL_it: PASN1_ITEM;

  function PKCS7_ISSUER_AND_SERIAL_digest(data: PPKCS7_ISSUER_AND_SERIAL; const &type: PEVP_MD; md: PByte; len: PIdC_UINT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function i2d_PKCS7_bio_stream(&out: PBIO; p7: PPKCS7; &in: PBIO; flags: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function PEM_write_bio_PKCS7_stream(&out: PBIO; p7: PPKCS7; &in: PBIO; flags: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;

//  function PKCS7_SIGNER_INFO_new: PPKCS7_SIGNER_INFO;
//  procedure PKCS7_SIGNER_INFO_free(a: PPKCS7_SIGNER_INFO);
//  function d2i_PKCS7_SIGNER_INFO(a: PPPKCS7_SIGNER_INFO; const &in: PByte; len: TIdC_LONG): PPKCS7_SIGNER_INFO;
//  function i2d_PKCS7_SIGNER_INFO(const a: PPKCS7_SIGNER_INFO; &out: PByte): TIdC_INT;
...
//  function d2i_PKCS7_RECIP_INFO(a: PPPKCS7_RECIP_INFO; const &in: PByte; len: TIdC_LONG): PPKCS7_RECIP_INFO;
//  function i2d_PKCS7_RECIP_INFO(const a: PPKCS7_RECIP_INFO; &out: PByte): TIdC_INT;
...
//  function d2i_PKCS7_SIGNED(a: PPPKCS7_SIGNED; const &in: PByte; len: TIdC_LONG): PPKCS7_SIGNED;
//  function i2d_PKCS7_SIGNED(const a: PPKCS7_SIGNED; &out: PByte): TIdC_INT;
...
//  function d2i_PKCS7_ENC_CONTENT(a: PPPKCS7_ENC_CONTENT; const &in: PByte; len: TIdC_LONG): PPKCS7_ENC_CONTENT;
//  function i2d_PKCS7_ENC_CONTENT(const a: PPKCS7_ENC_CONTENT; &out: PByte): TIdC_INT;
...
//  function d2i_PKCS7_ENVELOPE(a: PPPKCS7_ENVELOPE; const &in: PByte; len: TIdC_LONG): PPKCS7_ENVELOPE;
//  function i2d_PKCS7_ENVELOPE(const a: PPKCS7_ENVELOPE; &out: PByte): TIdC_INT;
...
//  function d2i_PKCS7_SIGN_ENVELOPE(a: PPPKCS7_SIGN_ENVELOPE; const &in: PByte; len: TIdC_LONG): PPKCS7_SIGN_ENVELOPE;
//  function i2d_PKCS7_SIGN_ENVELOPE(const a: PPKCS7_SIGN_ENVELOPE; &out: PByte): TIdC_INT;
...
//  function d2i_PKCS7_DIGEST(a: PPPKCS7_DIGEST; const &in: PByte; len: TIdC_LONG): PPKCS7_DIGEST;
//  function i2d_PKCS7_DIGEST(const a: PPKCS7_DIGEST; &out: PByte): TIdC_INT;
...
//  function d2i_PKCS7_ENCRYPT(a: PPPKCS7_ENCRYPT_STRUCT; const &in: PByte; len: TIdC_LONG): PPKCS7_ENCRYPT_STRUCT;
//  function i2d_PKCS7_ENCRYPT(const a: PPKCS7_ENCRYPT_STRUCT; &out: PByte): TIdC_INT;
//  function PKCS7_ENCRYPT_it: PASN1_ITEM;
//
//  function PKCS7_new: PPKCS7;
//  procedure PKCS7_free(a: PPKCS7);
//  function d2i_PKCS7(a: PPPKCS7; const &in: PByte; len: TIdC_LONG): PPKCS7;
//  function i2d_PKCS7(const a: PPKCS7; &out: PByte): TIdC_INT;
...
//
//  function i2d_PKCS7_NDEF(const a: PPKCS7; &out: PPByte): TIdC_INT;
//  function PKCS7_print_ctx(&out: PBIO; const x: PPKCS7; indent: TIdC_INT; const pctx: PASN1_PCTX): TIdC_INT;
  ...
  function PKCS7_set_type(p7: PPKCS7; &type: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function PKCS7_set0_type_other(p7: PPKCS7; &type: TIdC_INT; other: PASN1_TYPE): TIdC_INT cdecl; external CLibCrypto;
...
//  function PKCS7_get_signer_info(p7: PPKCS7): PSTACK_OF_PKCS7_SIGNER_INFO;
  ...
  function PKCS7_add_signed_attribute(p7si: PPKCS7_SIGNER_INFO; nid: TIdC_INT; &type: TIdC_INT; data: Pointer): TIdC_INT cdecl; external CLibCrypto;
  ...
  //function PKCS7_verify(p7: PPKCS7; certs: PSTACK_OF_X509; store: PX509_STORE; indata: PBIO; &out: PBIO; flags: TIdC_INT): TIdC_INT;
  //function PKCS7_get0_signers(p7: PPKCS7; certs: PSTACK_OF_X509; flags: TIdC_INT): PSTACK_OF_X509;
  //function PKCS7_encrypt(certs: PSTACK_OF_X509; &in: PBIO; const cipher: PEVP_CIPHER; flags: TIdC_INT): PPKCS7;
