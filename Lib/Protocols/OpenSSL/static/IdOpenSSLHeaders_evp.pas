...
{$ENDREGION}
  ...
  function EVP_MD_meth_new(md_type: TIdC_INT; pkey_type: TIdC_INT): PEVP_MD cdecl; external CLibCrypto;
  ...
  function EVP_MD_meth_set_input_blocksize(md: PEVP_MD; blocksize: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_set_result_size(md: PEVP_MD; resultsize: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_set_app_datasize(md: PEVP_MD; datasize: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_set_flags(md: PEVP_MD; flags: TIdC_ULONG): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_set_init(md: PEVP_MD; init: EVP_MD_meth_init): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_set_update(md: PEVP_MD; update: EVP_MD_meth_update): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_set_final(md: PEVP_MD; &final: EVP_MD_meth_final): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_set_copy(md: PEVP_MD; copy: EVP_MD_meth_copy): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_set_cleanup(md: PEVP_MD; cleanup: EVP_MD_meth_cleanup): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_set_ctrl(md: PEVP_MD; ctrl: EVP_MD_meth_ctrl): TIdC_INT cdecl; external CLibCrypto;

  function EVP_MD_meth_get_input_blocksize(const md: PEVP_MD): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_get_result_size(const md: PEVP_MD): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_get_app_datasize(const md: PEVP_MD): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_meth_get_flags(const md: PEVP_MD): TIdC_ULONG cdecl; external CLibCrypto;
  ...
  function EVP_CIPHER_meth_new(cipher_type: TIdC_INT; block_size: TIdC_INT; key_len: TIdC_INT): PEVP_CIPHER cdecl; external CLibCrypto;
  ...
  function EVP_CIPHER_meth_set_iv_length(cipher: PEVP_CIPHER; iv_len: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_meth_set_flags(cipher: PEVP_CIPHER; flags: TIdC_ULONG): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_meth_set_impl_ctx_size(cipher: PEVP_CIPHER; ctx_size: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_meth_set_init(cipher: PEVP_CIPHER; init: EVP_CIPHER_meth_init): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_meth_set_do_cipher(cipher: PEVP_CIPHER; do_cipher: EVP_CIPHER_meth_do_cipher): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_meth_set_cleanup(cipher: PEVP_CIPHER; cleanup: EVP_CIPHER_meth_cleanup): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_meth_set_set_asn1_params(cipher: PEVP_CIPHER; set_asn1_parameters: EVP_CIPHER_meth_set_asn1_params): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_meth_set_get_asn1_params(cipher: PEVP_CIPHER; get_asn1_parameters: EVP_CIPHER_meth_get_asn1_params): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_meth_set_ctrl(cipher: PEVP_CIPHER; ctrl: EVP_CIPHER_meth_ctrl): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_MD_type(const md: PEVP_MD): TIdC_INT cdecl; external CLibCrypto;
  //# define EVP_MD_nid(e)                   EVP_MD_type(e)
  //# define EVP_MD_name(e)                  OBJ_nid2sn(EVP_MD_nid(e))
  function EVP_MD_pkey_type(const md: PEVP_MD): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_size(const md: PEVP_MD): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_block_size(const md: PEVP_MD): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_flags(const md: PEVP_MD): PIdC_ULONG cdecl; external CLibCrypto;
  ...
  function EVP_MD_CTX_pkey_ctx(const ctx: PEVP_MD_CTX): PEVP_PKEY_CTX cdecl; external CLibCrypto;
  procedure EVP_MD_CTX_set_pkey_ctx(ctx: PEVP_MD_CTX; pctx: PEVP_PKEY_CTX) cdecl; external CLibCrypto;
  function EVP_MD_CTX_md_data(const ctx: PEVP_MD_CTX): Pointer cdecl; external CLibCrypto;

  function EVP_CIPHER_nid(const ctx: PEVP_MD_CTX): TIdC_INT cdecl; external CLibCrypto;
  //# define EVP_CIPHER_name(e)              OBJ_nid2sn(EVP_CIPHER_nid(e))
  function EVP_CIPHER_block_size(const cipher: PEVP_CIPHER): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_impl_ctx_size(const cipher: PEVP_CIPHER): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_key_length(const cipher: PEVP_CIPHER): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_iv_length(const cipher: PEVP_CIPHER): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_flags(const cipher: PEVP_CIPHER): TIdC_ULONG cdecl; external CLibCrypto;
  //# define EVP_CIPHER_mode(e)              (EVP_CIPHER_flags(e) & EVP_CIPH_MODE)

  function EVP_CIPHER_CTX_cipher(const ctx: PEVP_CIPHER_CTX): PEVP_CIPHER cdecl; external CLibCrypto;
  function EVP_CIPHER_CTX_encrypting(const ctx: PEVP_CIPHER_CTX): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_CTX_nid(const ctx: PEVP_CIPHER_CTX): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_CTX_block_size(const ctx: PEVP_CIPHER_CTX): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_CTX_key_length(const ctx: PEVP_CIPHER_CTX): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_CTX_iv_length(const ctx: PEVP_CIPHER_CTX): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_CIPHER_CTX_copy(&out: PEVP_CIPHER_CTX; const &in: PEVP_CIPHER_CTX): TIdC_INT cdecl; external CLibCrypto;
  ...
  procedure BIO_set_md(v1: PBIO; const md: PEVP_MD) cdecl; external CLibCrypto;
  ...
  function EVP_MD_CTX_ctrl(ctx: PEVP_MD_CTX; cmd: TIdC_INT; p1: TIdC_INT; p2: Pointer): TIdC_INT cdecl; external CLibCrypto;
  function EVP_MD_CTX_new: PEVP_MD_CTX cdecl; external CLibCrypto;
  function EVP_MD_CTX_reset(ctx: PEVP_MD_CTX): TIdC_INT cdecl; external CLibCrypto;
  procedure EVP_MD_CTX_free(ctx: PEVP_MD_CTX) cdecl; external CLibCrypto;
  //# define EVP_MD_CTX_create()     EVP_MD_CTX_new()
  //# define EVP_MD_CTX_init(ctx)    EVP_MD_CTX_reset((ctx))
  //# define EVP_MD_CTX_destroy(ctx) EVP_MD_CTX_free((ctx))
  function EVP_MD_CTX_copy_ex(&out: PEVP_MD_CTX; const &in: PEVP_MD_CTX): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_DigestInit_ex(ctx: PEVP_MD_CTX; const &type: PEVP_MD; impl: PENGINE): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_Digest(const data: Pointer; count: TIdC_SIZET; md: PByte; size: PIdC_UINT; const &type: PEVP_MD; impl: PENGINE): TIdC_INT cdecl; external CLibCrypto;

  function EVP_MD_CTX_copy(&out: PEVP_MD_CTX; const &in: PEVP_MD_CTX): TIdC_INT cdecl; external CLibCrypto;
  function EVP_DigestInit(ctx: PEVP_MD_CTX; const &type: PEVP_MD): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_BytesToKey(const &type: PEVP_CIPHER; const md: PEVP_MD; const salt: PByte; const data: PByte; data1: TIdC_INT; count: TIdC_INT; key: PByte; iv: PByte): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_EncryptUpdate(ctx: PEVP_CIPHER_CTX; &out: PByte; out1: PIdC_INT; const &in: PByte; &in1: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function EVP_EncryptFinal_ex(ctx: PEVP_CIPHER_CTX; &out: PByte; out1: PIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function EVP_EncryptFinal(ctx: PEVP_CIPHER_CTX; &out: PByte; out1: PIdC_INT): TIdC_INT cdecl; external CLibCrypto;

  function EVP_DecryptInit(ctx: PEVP_CIPHER_CTX; &out: PByte; out1: PidC_INT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_DecryptUpdate(ctx: PEVP_CIPHER_CTX; &out: PByte; out1: PIdC_INT; const &in: PByte; &in1: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_CipherUpdate(ctx: PEVP_CIPHER_CTX; &out: PByte; out1: PIdC_INT; const &in: PByte; in1: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_DigestSign(ctx: PEVP_CIPHER_CTX; sigret: PByte; siglen: PIdC_SIZET; const tbs: PByte; tbslen: TIdC_SIZET): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_DigestVerify(ctx: PEVP_CIPHER_CTX; const sigret: PByte; siglen: TIdC_SIZET; const tbs: PByte; tbslen: TIdC_SIZET): TIdC_INT cdecl; external CLibCrypto;

  function EVP_DigestSignInit(ctx: PEVP_CIPHER_CTX; pctx: PPEVP_PKEY_CTX; const &type: PEVP_MD; e: PENGINE; pkey: PEVP_PKEY): TIdC_INT cdecl; external CLibCrypto;
  function EVP_DigestSignFinal(ctx: PEVP_CIPHER_CTX; sigret: PByte; siglen: PIdC_SIZET): TIdC_INT cdecl; external CLibCrypto;

  function EVP_DigestVerifyInit(ctx: PEVP_MD_CTX; ppctx: PPEVP_PKEY_CTX; const &type: PEVP_MD; e: PENGINE; pkey: PEVP_PKEY): TIdC_INT cdecl; external CLibCrypto;
  function EVP_DigestVerifyFinal(ctx: PEVP_MD_CTX; const sig: PByte; siglen: TIdC_SIZET): TIdC_INT cdecl; external CLibCrypto;

  function EVP_OpenInit(ctx: PEVP_CIPHER_CTX; const &type: PEVP_CIPHER; const ek: PByte; ek1: TIdC_INT; const iv: PByte; priv: PEVP_PKEY): TIdC_INT cdecl; external CLibCrypto;
  function EVP_OpenFinal(ctx: PEVP_CIPHER_CTX; &out: PByte; out1: PIdC_INT): TIdC_INT cdecl; external CLibCrypto;

  function EVP_SealInit(ctx: PEVP_CIPHER_CTX; const &type: EVP_CIPHER; ek: PPByte; ek1: PIdC_INT; iv: PByte; pubk: PPEVP_PKEY; npubk: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function EVP_SealFinal(ctx: PEVP_CIPHER_CTX; &out: PByte; out1: PIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_ENCODE_CTX_copy(dctx: PEVP_ENCODE_CTX; sctx: PEVP_ENCODE_CTX): TIdC_INT cdecl; external CLibCrypto;
  function EVP_ENCODE_CTX_num(ctx: PEVP_ENCODE_CTX): TIdC_INT cdecl; external CLibCrypto;
  procedure EVP_EncodeInit(ctx: PEVP_ENCODE_CTX) cdecl; external CLibCrypto;
  function EVP_EncodeUpdate(ctx: PEVP_ENCODE_CTX; &out: PByte; out1: PIdC_INT; const &in: PByte; in1: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  procedure EVP_EncodeFinal(ctx: PEVP_ENCODE_CTX; &out: PByte; out1: PIdC_INT) cdecl; external CLibCrypto;
  ...
  function EVP_DecodeUpdate(ctx: PEVP_ENCODE_CTX; &out: PByte; out1: PIdC_INT; const &in: PByte; in1: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  function EVP_DecodeFinal(ctx: PEVP_ENCODE_CTX; &out: PByte; out1: PIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_CIPHER_CTX_reset(c: PEVP_CIPHER_CTX): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_CIPHER_CTX_ctrl(ctx: PEVP_CIPHER_CTX; &type: TIdC_INT; arg: TIdC_INT; ptr: Pointer): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_md5: PEVP_MD cdecl; external CLibCrypto;
  ...
  function EVP_idea_ecb: PEVP_CIPHER cdecl; external CLibCrypto;
  function EVP_idea_cfb64: PEVP_CIPHER cdecl; external CLibCrypto;
  //EVP_idea_cfb EVP_idea_cfb64
  function EVP_idea_ofb: PEVP_CIPHER cdecl; external CLibCrypto;
  function EVP_idea_cbc: PEVP_CIPHER cdecl; external CLibCrypto;
  ...
  function EVP_rc5_32_12_16_cbc: PEVP_CIPHER cdecl; external CLibCrypto;
  function EVP_rc5_32_12_16_ecb: PEVP_CIPHER cdecl; external CLibCrypto;
  function EVP_rc5_32_12_16_cfb64: PEVP_CIPHER cdecl; external CLibCrypto;
  //EVP_rc5_32_12_16_cfb EVP_rc5_32_12_16_cfb64
  function EVP_rc5_32_12_16_ofb: PEVP_CIPHER cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_security_bits(const pkey: PEVP_PKEY): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_size(const pkey: PEVP_PKEY): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_set_alias_type(pkey: PEVP_PKEY; &type: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;

  function EVP_PKEY_set1_engine(pkey: PEVP_PKEY; e: PENGINE): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_get0_engine(const pkey: PEVP_PKEY): PENGINE cdecl; external CLibCrypto;

  function EVP_PKEY_assign(pkey: PEVP_PKEY; &type: TIdC_INT; key: Pointer): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_get0(const pkey: PEVP_PKEY): Pointer cdecl; external CLibCrypto;
  function EVP_PKEY_get0_hmac(const pkey: PEVP_PKEY; len: PIdC_SIZET): PByte cdecl; external CLibCrypto;
  function EVP_PKEY_get0_poly1305(const pkey: PEVP_PKEY; len: PIdC_SIZET): PByte cdecl; external CLibCrypto;
  function EVP_PKEY_get0_siphash(const pkey: PEVP_PKEY; len: PIdC_SIZET): PByte cdecl; external CLibCrypto;

  function EVP_PKEY_set1_RSA(pkey: PEVP_PKEY): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_get0_RSA(pkey: PEVP_PKEY): Prsa_st cdecl; external CLibCrypto;
  function EVP_PKEY_get1_RSA(pkey: PEVP_PKEY): Prsa_st cdecl; external CLibCrypto;

  function EVP_PKEY_set1_DSA(pkey: PEVP_PKEY): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_get0_DSA(pkey: PEVP_PKEY): Pdsa_st cdecl; external CLibCrypto;
  function EVP_PKEY_get1_DSA(pkey: PEVP_PKEY): Pdsa_st cdecl; external CLibCrypto;

  function EVP_PKEY_set1_DH(pkey: PEVP_PKEY; key: Pdh_st): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_get0_DH(pkey: PEVP_PKEY): Pdh_st cdecl; external CLibCrypto;
  function EVP_PKEY_get1_DH(pkey: PEVP_PKEY): Pdh_st cdecl; external CLibCrypto;

  function EVP_PKEY_set1_EC_KEY(pkey: PEVP_PKEY; key: Pec_key_st): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_get0_EC_KEY(pkey: PEVP_PKEY): Pec_key_st cdecl; external CLibCrypto;
  function EVP_PKEY_get1_EC_KEY(pkey: PEVP_PKEY): Pec_key_st cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_copy_parameters(&to: PEVP_PKEY; const from: PEVP_PKEY): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_set1_tls_encodedpoint(pkey: PEVP_PKEY; const pt: PByte; ptlen: TIdC_SIZET): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_get1_tls_encodedpoint(pkey: PEVP_PKEY; ppt: PPByte): TIdC_SIZET cdecl; external CLibCrypto;

  function EVP_CIPHER_type(const ctx: PEVP_CIPHER): TIdC_INT cdecl; external CLibCrypto;

  (* calls methods *)
  function EVP_CIPHER_param_to_asn1(c: PEVP_CIPHER_CTX; &type: PASN1_TYPE): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_asn1_to_param(c: PEVP_CIPHER_CTX; &type: PASN1_TYPE): TIdC_INT cdecl; external CLibCrypto;

  (* These are used by EVP_CIPHER methods *)
  function EVP_CIPHER_set_asn1_iv(c: PEVP_CIPHER_CTX; &type: PASN1_TYPE): TIdC_INT cdecl; external CLibCrypto;
  function EVP_CIPHER_get_asn1_iv(c: PEVP_CIPHER_CTX; &type: PASN1_TYPE): TIdC_INT cdecl; external CLibCrypto;
  ...
  function PKCS5_PBKDF2_HMAC_SHA1(const pass: PIdAnsiChar; passlen: TIdC_INT; const salt: PByte; saltlen: TIdC_INT; iter: TIdC_INT; keylen: TIdC_INT; &out: PByte): TIdC_INT cdecl; external CLibCrypto;
  function PKCS5_PBKDF2_HMAC(const pass: PIdAnsiChar; passlen: TIdC_INT; const salt: PByte; saltlen: TIdC_INT; iter: TIdC_INT; const digest: PEVP_MD; keylen: TIdC_INT; &out: PByte): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_PBE_scrypt(const pass: PIdAnsiChar; passlen: TIdC_SIZET; const salt: PByte; saltlen: TIdC_SIZET; N: TIdC_UINT64; r: TIdC_UINT64; p: TIdC_UINT64; maxmem: TIdC_UINT64; key: PByte; keylen: TIdC_SIZET): TIdC_INT cdecl; external CLibCrypto;

  function PKCS5_v2_scrypt_keyivgen(ctx: PEVP_CIPHER_CTX; const pass: PIdAnsiChar; passlen: TIdC_INT; param: PASN1_TYPE; const c: PEVP_CIPHER; const md: PEVP_MD; en_de: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_asn1_find(pe: PPENGINE; &type: TIdC_INT): PEVP_PKEY_ASN1_METHOD cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_asn1_add_alias(&to: TIdC_INT; from: TIdC_INT): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_meth_remove(const pmeth: PEVP_PKEY_METHOD): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_meth_get_count: TIdC_SIZET cdecl; external CLibCrypto;
  function EVP_PKEY_meth_get0(idx: TIdC_SIZET): PEVP_PKEY_METHOD cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_CTX_ctrl_str(ctx: PEVP_PKEY_CTX; const &type: PIdAnsiChar; const value: PIdAnsiChar): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_CTX_ctrl_uint64(ctx: PEVP_PKEY_CTX; keytype: TIdC_INT; optype: TIdC_INT; cmd: TIdC_INT; value: TIdC_UINT64): TIdC_INT cdecl; external CLibCrypto;

  function EVP_PKEY_CTX_str2ctrl(ctx: PEVP_PKEY_CTX; cmd: TIdC_INT; const str: PIdAnsiChar): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_CTX_hex2ctrl(ctx: PEVP_PKEY_CTX; cmd: TIdC_INT; const hex: PIdAnsiChar): TIdC_INT cdecl; external CLibCrypto;

  function EVP_PKEY_CTX_md(ctx: PEVP_PKEY_CTX; optype: TIdC_INT; cmd: TIdC_INT; const md: PIdAnsiChar): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_new_CMAC_key(e: PENGINE; const priv: PByte; len: TIdC_SIZET; const cipher: PEVP_CIPHER): PEVP_PKEY cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_encrypt(ctx: PEVP_PKEY_CTX; &out: PByte; outlen: PIdC_SIZET; const &in: PByte; inlen: TIdC_SIZET): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_decrypt_init(ctx: PEVP_PKEY_CTX): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_decrypt(ctx: PEVP_PKEY_CTX; &out: PByte; outlen: PIdC_SIZET; const &in: PByte; inlen: TIdC_SIZET): TIdC_INT cdecl; external CLibCrypto;
  ...
  function EVP_PKEY_check(ctx: PEVP_PKEY_CTX): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_public_check(ctx: PEVP_PKEY_CTX): TIdC_INT cdecl; external CLibCrypto;
  function EVP_PKEY_param_check(ctx: PEVP_PKEY_CTX): TIdC_INT cdecl; external CLibCrypto;
