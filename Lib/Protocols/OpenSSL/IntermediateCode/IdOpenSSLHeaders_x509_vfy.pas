...
var
  ...
  procedure X509_STORE_CTX_set_depth(ctx: PX509_STORE_CTX; depth: TIdC_INT);
  ...
  //                                        X509_OBJECT *x);
  function X509_OBJECT_up_ref_count(a: PX509_OBJECT): TIdC_INT;
  function X509_OBJECT_new: PX509_OBJECT;
  procedure X509_OBJECT_free(a: PX509_OBJECT);
  function X509_OBJECT_get_type(const a: PX509_OBJECT): X509_LOOKUP_TYPE;
  function X509_OBJECT_get0_X509(const a: PX509_OBJECT): PX509;
  function X509_OBJECT_set1_X509(a: PX509_OBJECT; obj: PX509): TIdC_INT;
  function X509_OBJECT_get0_X509_CRL(a: PX509_OBJECT): PX509_CRL;
  function X509_OBJECT_set1_X509_CRL(a: PX509_OBJECT; obj: PX509_CRL): TIdC_INT;
  function X509_STORE_new: PX509_STORE;
  procedure X509_STORE_free(v: PX509_STORE);
  function X509_STORE_lock(ctx: PX509_STORE): TIdC_INT;
  function X509_STORE_unlock(ctx: PX509_STORE): TIdC_INT;
  function X509_STORE_up_ref(v: PX509_STORE): TIdC_INT;
  ...
  function X509_STORE_set_flags(ctx: PX509_STORE; flags: TIdC_ULONG): TIdC_INT;
  function X509_STORE_set_purpose(ctx: PX509_STORE; purpose: TIdC_INT): TIdC_INT;
  function X509_STORE_set_trust(ctx: PX509_STORE; trust: TIdC_INT): TIdC_INT;
  function X509_STORE_set1_param(ctx: PX509_STORE; pm: PX509_VERIFY_PARAM): TIdC_INT;
  function X509_STORE_get0_param(ctx: PX509_STORE): PX509_VERIFY_PARAM;

  procedure X509_STORE_set_verify(ctx: PX509_STORE; verify: X509_STORE_CTX_verify_fn);
  //#define X509_STORE_set_verify_func(ctx, func) \
  //            X509_STORE_set_verify((ctx),(func))
  procedure X509_STORE_CTX_set_verify(ctx: PX509_STORE_CTX; verify: X509_STORE_CTX_verify_fn);
  function X509_STORE_get_verify(ctx: PX509_STORE): X509_STORE_CTX_verify_fn;
  procedure X509_STORE_set_verify_cb(ctx: PX509_STORE; verify_cb: X509_STORE_CTX_verify_cb);
  //# define X509_STORE_set_verify_cb_func(ctx,func) \
  //            X509_STORE_set_verify_cb((ctx),(func))
  function X509_STORE_get_verify_cb(ctx: PX509_STORE): X509_STORE_CTX_verify_cb;
  procedure X509_STORE_set_get_issuer(ctx: PX509_STORE; get_issuer: X509_STORE_CTX_get_issuer_fn);
  function X509_STORE_get_get_issuer(ctx: PX509_STORE): X509_STORE_CTX_get_issuer_fn;
  procedure X509_STORE_set_check_issued(ctx: PX509_STORE; check_issued: X509_STORE_CTX_check_issued_fn);
  function X509_STORE_get_check_issued(ctx: PX509_STORE): X509_STORE_CTX_check_issued_fn;
  procedure X509_STORE_set_check_revocation(ctx: PX509_STORE; check_revocation: X509_STORE_CTX_check_revocation_fn);
  function X509_STORE_get_check_revocation(ctx: PX509_STORE): X509_STORE_CTX_check_revocation_fn;
  procedure X509_STORE_set_get_crl(ctx: PX509_STORE; get_crl: X509_STORE_CTX_get_crl_fn);
  function X509_STORE_get_get_crl(ctx: PX509_STORE): X509_STORE_CTX_get_crl_fn;
  procedure X509_STORE_set_check_crl(ctx: PX509_STORE; check_crl: X509_STORE_CTX_check_crl_fn);
  function X509_STORE_get_check_crl(ctx: PX509_STORE): X509_STORE_CTX_check_crl_fn;
  procedure X509_STORE_set_cert_crl(ctx: PX509_STORE; cert_crl: X509_STORE_CTX_cert_crl_fn);
  function X509_STORE_get_cert_crl(ctx: PX509_STORE): X509_STORE_CTX_cert_crl_fn;
  procedure X509_STORE_set_check_policy(ctx: PX509_STORE; check_policy: X509_STORE_CTX_check_policy_fn);
  function X509_STORE_get_check_policy(ctx: PX509_STORE): X509_STORE_CTX_check_policy_fn;
...
//  function X509_STORE_get_lookup_crls(ctx: PX509_STORE): X509_STORE_CTX_lookup_crls_fn;
  procedure X509_STORE_set_cleanup(ctx: PX509_STORE; cleanup: X509_STORE_CTX_cleanup_fn);
  function X509_STORE_get_cleanup(ctx: PX509_STORE): X509_STORE_CTX_cleanup_fn;

  //#define X509_STORE_get_ex_new_index(l, p, newf, dupf, freef) \
  //    CRYPTO_get_ex_new_index(CRYPTO_EX_INDEX_X509_STORE, l, p, newf, dupf, freef)
  function X509_STORE_set_ex_data(ctx: PX509_STORE; idx: TIdC_INT; data: Pointer): TIdC_INT;
  function X509_STORE_get_ex_data(ctx: PX509_STORE; idx: TIdC_INT): Pointer;

  function X509_STORE_CTX_new: PX509_STORE_CTX;

  function X509_STORE_CTX_get1_issuer(issuer: PPX509; ctx: PX509_STORE_CTX; x: PX509): TIdC_INT;
...
//  procedure X509_STORE_CTX_set0_trusted_stack(ctx: PX509_STORE_CTX; sk: P STACK_OF(X509));
  ...
  function X509_STORE_CTX_get0_store(ctx: PX509_STORE_CTX): PX509_STORE;
  function X509_STORE_CTX_get0_cert(ctx: PX509_STORE_CTX): PX509;
  //STACK_OF(X509)* X509_STORE_CTX_get0_untrusted(X509_STORE_CTX *ctx);
  //void X509_STORE_CTX_set0_untrusted(X509_STORE_CTX *ctx, STACK_OF(X509) *sk);
  procedure X509_STORE_CTX_set_verify_cb(ctx: PX509_STORE_CTX; verify: X509_STORE_CTX_verify_cb);
...
//  function X509_STORE_CTX_get_lookup_crls(ctx: PX509_STORE_CTX): X509_STORE_CTX_lookup_crls_fn;
  ...
  function X509_LOOKUP_meth_new(const name: PIdAnsiChar): PX509_LOOKUP_METHOD;
  procedure X509_LOOKUP_meth_free(method: PX509_LOOKUP_METHOD);
  ...
  function X509_LOOKUP_meth_set_ctrl(method: PX509_LOOKUP_METHOD; ctrl_fn: X509_LOOKUP_ctrl_fn): TIdC_INT;
  function X509_LOOKUP_meth_get_ctrl(const method: PX509_LOOKUP_METHOD): X509_LOOKUP_ctrl_fn;

  function X509_LOOKUP_meth_set_get_by_subject(method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_subject_fn): TIdC_INT;
  function X509_LOOKUP_meth_get_get_by_subject(const method: PX509_LOOKUP_METHOD): X509_LOOKUP_get_by_subject_fn;

  function X509_LOOKUP_meth_set_get_by_issuer_serial(method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_issuer_serial_fn): TIdC_INT;
  function X509_LOOKUP_meth_get_get_by_issuer_serial(const method: PX509_LOOKUP_METHOD): X509_LOOKUP_get_by_issuer_serial_fn;

  function X509_LOOKUP_meth_set_get_by_fingerprint(method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_fingerprint_fn): TIdC_INT;
  function X509_LOOKUP_meth_get_get_by_fingerprint(const method: PX509_LOOKUP_METHOD): X509_LOOKUP_get_by_fingerprint_fn;

  function X509_LOOKUP_meth_set_get_by_alias(method: PX509_LOOKUP_METHOD; fn: X509_LOOKUP_get_by_alias_fn): TIdC_INT;
  function X509_LOOKUP_meth_get_get_by_alias(const method: PX509_LOOKUP_METHOD): X509_LOOKUP_get_by_alias_fn;

  function X509_STORE_add_cert(ctx: PX509_STORE; x: PX509): TIdC_INT;
  function X509_STORE_add_crl(ctx: PX509_STORE; x: PX509_CRL): TIdC_INT;

  function X509_STORE_CTX_get_by_subject(vs: PX509_STORE_CTX; &type: X509_LOOKUP_TYPE; name: PX509_NAME; ret: PX509_OBJECT): TIdC_INT;
  function X509_STORE_CTX_get_obj_by_subject(vs: PX509_STORE_CTX; &type: X509_LOOKUP_TYPE; name: PX509_NAME): PX509_OBJECT;

  function X509_LOOKUP_ctrl(ctx: PX509_LOOKUP; cmd: TIdC_INT; const argc: PIdAnsiChar; argl: TIdC_LONG; ret: PPIdAnsiChar): TIdC_INT;

  function X509_load_cert_file(ctx: PX509_LOOKUP; const &file: PIdAnsiChar; &type: TIdC_INT): TIdC_INT;
  function X509_load_crl_file(ctx: PX509_LOOKUP; const &file: PIdAnsiChar; &type: TIdC_INT): TIdC_INT;
  function X509_load_cert_crl_file(ctx: PX509_LOOKUP; const &file: PIdAnsiChar; &type: TIdC_INT): TIdC_INT;

  function X509_LOOKUP_new(method: PX509_LOOKUP_METHOD): PX509_LOOKUP;
  procedure X509_LOOKUP_free(ctx: PX509_LOOKUP);
  function X509_LOOKUP_init(ctx: PX509_LOOKUP): TIdC_INT;
  function X509_LOOKUP_by_subject(ctx: PX509_LOOKUP; &type: X509_LOOKUP_TYPE; name: PX509_NAME; ret: PX509_OBJECT): TIdC_INT;
  function X509_LOOKUP_by_issuer_serial(ctx: PX509_LOOKUP; &type: X509_LOOKUP_TYPE; name: PX509_NAME; serial: PASN1_INTEGER; ret: PX509_OBJECT): TIdC_INT;
  function X509_LOOKUP_by_fingerprint(ctx: PX509_LOOKUP; &type: X509_LOOKUP_TYPE; const bytes: PByte; len: TIdC_INT; ret: PX509_OBJECT): TIdC_INT;
  function X509_LOOKUP_by_alias(ctx: PX509_LOOKUP; &type: X509_LOOKUP_TYPE; const str: PIdAnsiChar; len: TIdC_INT; ret: PX509_OBJECT): TIdC_INT;
  function X509_LOOKUP_set_method_data(ctx: PX509_LOOKUP; data: Pointer): TIdC_INT;
  function X509_LOOKUP_get_method_data(const ctx: PX509_LOOKUP): Pointer;
  function X509_LOOKUP_get_store(const ctx: PX509_LOOKUP): PX509_STORE;
  function X509_LOOKUP_shutdown(ctx: PX509_LOOKUP): TIdC_INT;

  function X509_STORE_load_locations(ctx: PX509_STORE; const &file: PIdAnsiChar; const dir: PIdAnsiChar): TIdC_INT;
  function X509_STORE_set_default_paths(ctx: PX509_STORE): TIdC_INT;

  //#define X509_STORE_CTX_get_ex_new_index(l, p, newf, dupf, freef) \
  //    CRYPTO_get_ex_new_index(CRYPTO_EX_INDEX_X509_STORE_CTX, l, p, newf, dupf, freef)
  function X509_STORE_CTX_set_ex_data(ctx: PX509_STORE_CTX; idx: TIdC_INT; data: Pointer): TIdC_INT;
  function X509_STORE_CTX_get_ex_data(ctx: PX509_STORE_CTX; idx: TIdC_INT): Pointer;
  function X509_STORE_CTX_get_error(ctx: PX509_STORE_CTX): TIdC_INT;
  procedure X509_STORE_CTX_set_error(ctx: X509_STORE_CTX; s: TIdC_INT);
  function X509_STORE_CTX_get_error_depth(ctx: PX509_STORE_CTX): TIdC_INT;
  procedure X509_STORE_CTX_set_error_depth(ctx: PX509_STORE_CTX; depth: TIdC_INT);
...
//  void X509_STORE_CTX_set0_crls(X509_STORE_CTX *c, STACK_OF(X509_CRL) *sk);
  function X509_STORE_CTX_set_purpose(ctx: PX509_STORE_CTX; purpose: TIdC_INT): TIdC_INT;
...
//  procedure X509_STORE_CTX_set_time(ctx: PX509_STORE_CTX; flags: TIdC_ULONG; t: TIdC_TIMET);
  ...
  function X509_STORE_CTX_get_num_untrusted(ctx: PX509_STORE_CTX): TIdC_INT;

  function X509_STORE_CTX_get0_param(ctx: PX509_STORE_CTX): PX509_VERIFY_PARAM;
  procedure X509_STORE_CTX_set0_param(ctx: PX509_STORE_CTX; param: PX509_VERIFY_PARAM);
  function X509_STORE_CTX_set_default(ctx: PX509_STORE_CTX; const name: PIdAnsiChar): TIdC_INT;
  ...
  function X509_VERIFY_PARAM_inherit(&to: PX509_VERIFY_PARAM; const from: PX509_VERIFY_PARAM): TIdC_INT;
  function X509_VERIFY_PARAM_set1(&to: PX509_VERIFY_PARAM; const from: PX509_VERIFY_PARAM): TIdC_INT;
  function X509_VERIFY_PARAM_set1_name(param: PX509_VERIFY_PARAM; const name: PIdAnsiChar): TIdC_INT;
  function X509_VERIFY_PARAM_set_flags(param: PX509_VERIFY_PARAM; flags: TIdC_ULONG): TIdC_INT;
  function X509_VERIFY_PARAM_clear_flags(param: PX509_VERIFY_PARAM; flags: TIdC_ULONG): TIdC_INT;
  function X509_VERIFY_PARAM_get_flags(param: PX509_VERIFY_PARAM): TIdC_ULONG;
  function X509_VERIFY_PARAM_set_purpose(param: PX509_VERIFY_PARAM; purpose: TIdC_INT): TIdC_INT;
...
//  procedure X509_VERIFY_PARAM_set_time(param: PX509_VERIFY_PARAM; t: TIdC_TIMET);
  ...
  function X509_VERIFY_PARAM_get_auth_level(const param: PX509_VERIFY_PARAM): TIdC_INT;
  function X509_VERIFY_PARAM_get0_name(const param: PX509_VERIFY_PARAM): PIdAnsiChar;

  function X509_VERIFY_PARAM_add0_table(param: PX509_VERIFY_PARAM): TIdC_INT;
  function X509_VERIFY_PARAM_get_count: TIdC_INT;
  function X509_VERIFY_PARAM_get0(id: TIdC_INT): PX509_VERIFY_PARAM;
  function X509_VERIFY_PARAM_lookup(const name: PIdAnsiChar): X509_VERIFY_PARAM;
  procedure X509_VERIFY_PARAM_table_cleanup;
  ...
  function X509_policy_tree_level_count(const tree: PX509_POLICY_TREE): TIdC_INT;
  function X509_policy_tree_get0_level(const tree: PX509_POLICY_TREE; i: TIdC_INT): PX509_POLICY_LEVEL;
  ...
  function X509_policy_level_node_count(level: PX509_POLICY_LEVEL): TIdC_INT;

  function X509_policy_level_get0_node(level: PX509_POLICY_LEVEL; i: TIdC_INT): PX509_POLICY_NODE;

  function X509_policy_node_get0_policy(const node: PX509_POLICY_NODE): PASN1_OBJECT;

  //STACK_OF(POLICYQUALINFO) *X509_policy_node_get0_qualifiers(const
  //                                                           X509_POLICY_NODE
  //                                                           *node);
  function X509_policy_node_get0_parent(const node: PX509_POLICY_NODE): PX509_POLICY_NODE;
