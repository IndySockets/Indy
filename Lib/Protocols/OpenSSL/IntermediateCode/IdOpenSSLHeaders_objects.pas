...
var
  function OBJ_NAME_init: TIdC_INT;
...
//                              void *arg);
  ...
  function OBJ_nid2obj(n: TIdC_INT): PASN1_OBJECT;
  function OBJ_nid2ln(n: TIdC_INT): PIdAnsiChar;
  function OBJ_nid2sn(n: TIdC_INT): PIdAnsiChar;
  function OBJ_obj2nid(const o: PASN1_OBJECT): TIdC_INT;
  function OBJ_txt2obj(const s: PIdAnsiChar; no_name: TIdC_INT): PASN1_OBJECT;
  function OBJ_obj2txt(buf: PIdAnsiChar; buf_len: TIdC_INT; const a: PASN1_OBJECT; no_name: TIdC_INT): TIdC_INT;
  function OBJ_txt2nid(const s: PIdAnsiChar): TIdC_INT;
  function OBJ_ln2nid(const s: PIdAnsiChar): TIdC_INT;
  function OBJ_sn2nid(const s: PIdAnsiChar): TIdC_INT;
  function OBJ_cmp(const a: PASN1_OBJECT; const b: PASN1_OBJECT): TIdC_INT;
...
//                              TIdC_INT flags);
  ...
  function OBJ_find_sigid_algs(signid: TIdC_INT; pdig_nid: PIdC_INT; ppkey_nid: PIdC_INT): TIdC_INT;
  function OBJ_find_sigid_by_algs(psignid: PIdC_INT; dig_nid: TIdC_INT; pkey_nid: TIdC_INT): TIdC_INT;
