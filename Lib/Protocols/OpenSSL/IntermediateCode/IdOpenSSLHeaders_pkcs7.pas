...
var
  ...
  function PKCS7_ISSUER_AND_SERIAL_digest(data: PPKCS7_ISSUER_AND_SERIAL; const &type: PEVP_MD; md: PByte; len: PIdC_UINT): TIdC_INT;
  ...
  function i2d_PKCS7_bio_stream(&out: PBIO; p7: PPKCS7; &in: PBIO; flags: TIdC_INT): TIdC_INT;
  function PEM_write_bio_PKCS7_stream(&out: PBIO; p7: PPKCS7; &in: PBIO; flags: TIdC_INT): TIdC_INT;
...
//  function PKCS7_print_ctx(&out: PBIO; const x: PPKCS7; indent: TIdC_INT; const pctx: PASN1_PCTX): TIdC_INT;
  ...
  function PKCS7_set_type(p7: PPKCS7; &type: TIdC_INT): TIdC_INT;
  function PKCS7_set0_type_other(p7: PPKCS7; &type: TIdC_INT; other: PASN1_TYPE): TIdC_INT;
...
//  function PKCS7_get_signer_info(p7: PPKCS7): PSTACK_OF_PKCS7_SIGNER_INFO;
  ...
  function PKCS7_add_signed_attribute(p7si: PPKCS7_SIGNER_INFO; nid: TIdC_INT; &type: TIdC_INT; data: Pointer): TIdC_INT;
