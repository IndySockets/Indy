...
var
  ...
  function i2d_DSA_SIG(const a: PDSA_SIG; pp: PPByte): TIdC_INT;
  function d2i_DSA_SIG(v: PPDSA_SIG; const pp: PPByte; length: TIdC_LONG): PDSA_SIG;
  procedure DSA_SIG_get0(const sig: PDSA_SIG; const pr: PPBIGNUM; const ps: PPBIGNUM);
  function DSA_SIG_set0(sig: PDSA_SIG; r: PBIGNUM; s: PBIGNUM): TIdC_INT;
  
  function DSA_do_sign(const dgst: PByte; dlen: TIdC_INT; dsa: PDSA): PDSA_SIG;
  function DSA_do_verify(const dgst: PByte; dgst_len: TIdC_INT; sig: PDSA_SIG; dsa: PDSA): TIdC_INT;
  ...
  function DSA_set_method(dsa: PDSA; const v1: PDSA_METHOD): TIdC_INT;
  ...
  function DSA_up_ref(r: PDSA): TIdC_INT;
  ...
  function DSA_get_ex_data(d: PDSA; idx: TIdC_INT): Pointer;
  
  function d2i_DSAPublicKey(a: PPDSA; const pp: PPByte; length: TIdC_LONG): PDSA;
  function d2i_DSAPrivateKey(a: PPDSA; const pp: PPByte; length: TIdC_LONG): PDSA;
  function d2i_DSAparams(a: PPDSA; const pp: PPByte; length: TIdC_LONG): PDSA;

  function DSA_generate_parameters_ex(dsa: PDSA; bits: TIdC_INT; const seed: PByte; seed_len: TIdC_INT; counter_ret: PIdC_INT; h_ret: PIdC_ULONG; cb: PBN_GENCB): TIdC_INT;

  function DSA_generate_key(a: PDSA): TIdC_INT;
  function i2d_DSAPublicKey(const a: PDSA; pp: PPByte): TIdC_INT;
  function i2d_DSAPrivateKey(const a: PDSA; pp: PPByte): TIdC_INT;
  function i2d_DSAparams(const a: PDSA; pp: PPByte): TIdC_INT;
  
  function DSAparams_print(bp: PBIO; const x: PDSA): TIdC_INT;
  function DSA_print(bp: PBIO; const x: PDSA; off: TIdC_INT): TIdC_INT;
...
//  function DSA_print_fp(bp: PFile; const x: PDSA; off: TIdC_INT): TIdC_INT;
  ...
  function DSA_set0_pqg(d: PDSA; p: PBIGNUM; q: PBIGNUM; g: PBIGNUM): TIdC_INT;
  procedure DSA_get0_key(const d: PDSA; const pub_key: PPBIGNUM; const priv_key: PPBIGNUM);
  function DSA_set0_key(d: PDSA; pub_key: PBIGNUM; priv_key: PBIGNUM): TIdC_INT;
  ...
  procedure DSA_clear_flags(d: PDSA; flags: TIdC_INT);
  function DSA_test_flags(const d: PDSA; flags: TIdC_INT): TIdC_INT;
  procedure DSA_set_flags(d: PDSA; flags: TIdC_INT);
  function DSA_get0_engine(d: PDSA): PENGINE;
  
  function DSA_meth_new(const name: PIdAnsiChar; flags: TIdC_INT): PDSA_METHOD;
  procedure DSA_meth_free(dsam: PDSA_METHOD);
  function DSA_meth_dup(const dsam: PDSA_METHOD): PDSA_METHOD;
  function DSA_meth_get0_name(const dsam: PDSA_METHOD): PIdAnsiChar;
  function DSA_meth_set1_name(dsam: PDSA_METHOD; const name: PIdAnsiChar): TIdC_INT;
  function DSA_meth_get_flags(const dsam: PDSA_METHOD): TIdC_INT;
  function DSA_meth_set_flags(dsam: PDSA_METHOD; flags: TIdC_INT): TIdC_INT;
  function DSA_meth_get0_app_data(const dsam: PDSA_METHOD): Pointer;
  function DSA_meth_set0_app_data(dsam: PDSA_METHOD; app_data: Pointer): TIdC_INT;
  function DSA_meth_get_sign(const dsam: PDSA_METHOD): DSA_meth_sign_cb;
  function DSA_meth_set_sign(dsam: PDSA_METHOD; sign: DSA_meth_sign_cb): TIdC_INT;
  function DSA_meth_get_sign_setup(const dsam: PDSA_METHOD): DSA_meth_sign_setup_cb;
  function DSA_meth_set_sign_setup(dsam: PDSA_METHOD; sign_setup: DSA_meth_sign_setup_cb): TIdC_INT;
  function DSA_meth_get_verify(const dsam: PDSA_METHOD): DSA_meth_verify_cb;
  function DSA_meth_set_verify(dsam: PDSA_METHOD; verify: DSA_meth_verify_cb): TIdC_INT;
  function DSA_meth_get_mod_exp(const dsam: PDSA_METHOD): DSA_meth_mod_exp_cb;
  function DSA_meth_set_mod_exp(dsam: PDSA_METHOD; mod_exp: DSA_meth_mod_exp_cb): TIdC_INT;
  function DSA_meth_get_bn_mod_exp(const dsam: PDSA_METHOD): DSA_meth_bn_mod_exp_cb;
  function DSA_meth_set_bn_mod_exp(dsam: PDSA_METHOD; bn_mod_exp: DSA_meth_bn_mod_exp_cb): TIdC_INT;
  function DSA_meth_get_init(const dsam: PDSA_METHOD): DSA_meth_init_cb;
  function DSA_meth_set_init(dsam: PDSA_METHOD; init: DSA_meth_init_cb): TIdC_INT;
  function DSA_meth_get_finish(const dsam: PDSA_METHOD): DSA_meth_finish_cb;
  function DSA_meth_set_finish(dsam: PDSA_METHOD; finish: DSA_meth_finish_cb): TIdC_INT;
  function DSA_meth_get_paramgen(const dsam: PDSA_METHOD): DSA_meth_paramgen_cb;
  function DSA_meth_set_paramgen(dsam: PDSA_METHOD; paramgen: DSA_meth_paramgen_cb): TIdC_INT;
  function DSA_meth_get_keygen(const dsam: PDSA_METHOD): DSA_meth_keygen_cb;
  function DSA_meth_set_keygen(dsam: PDSA_METHOD; keygen: DSA_meth_keygen_cb): TIdC_INT;
