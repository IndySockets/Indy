...
// DEFINE_LHASH_OF(ERR_STRING_DATA);
  ...
  procedure ERR_put_error(lib: TIdC_INT; func: TIdC_INT; reason: TIdC_INT; &file: PIdAnsiChar; line: TIdC_INT);
  ...
  function ERR_load_strings(lib: TIdC_INT; str: PERR_STRING_DATA): TIdC_INT;
  function ERR_load_strings_const(str: PERR_STRING_DATA): TIdC_INT;
  function ERR_unload_strings(lib: TIdC_INT; str: PERR_STRING_DATA): TIdC_INT;
  function ERR_load_ERR_strings: TIdC_INT;

  function ERR_get_state: PERR_STATE;
  function ERR_get_next_error_library: TIdC_INT;
  function ERR_set_mark: TIdC_INT;
  function ERR_pop_to_mark: TIdC_INT;
  function ERR_clear_last_mark: TIdC_INT;
