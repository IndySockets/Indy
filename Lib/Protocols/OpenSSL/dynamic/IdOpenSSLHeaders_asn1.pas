...
// DECLARE_ASN1_FUNCTIONS_fname(ASN1_TYPE, ASN1_ANY, ASN1_TYPE)
  ...
  ASN1_TYPE_set: procedure(a: PASN1_TYPE; &type: TIdC_INT; value: Pointer) cdecl = nil;
  ASN1_TYPE_set1: function(a: PASN1_TYPE; &type: TIdC_INT; const value: Pointer): TIdC_INT cdecl = nil;
  ...
  ASN1_TIME_diff: function(pday: PIdC_INT; psec: PIdC_INT; const from: PASN1_TIME; const &to: PASN1_TIME): TIdC_INT cdecl = nil;
  ...
  i2a_ASN1_STRING: function(bp: PBIO; const a: PASN1_STRING; &type: TIdC_INT): TIdC_INT cdecl = nil;
  ...
  //
  //function ASN1_item_d2i_fp(const it: PASN1_ITEM; &in: PFILE; x: Pointer): Pointer;
  //function ASN1_i2d_fp(i2d: Pi2d_of_void; &out: PFILE; x: Pointer): TIdC_INT;
  //
  ...
  //                 CHECKED_PTR_OF(const type, x)))
  //
  //function ASN1_item_i2d_fp(const it: PASN1_ITEM; &out: PFILE; x: Pointer): TIdC_INT;
  //function ASN1_STRING_print_ex_fp(&fp: PFILE; const str: PASN1_STRING; flags: TIdC_ULONG): TIdC_INT;
  //# endif

  ASN1_STRING_to_UTF8: function(&out: PPByte; const &in: PASN1_STRING): TIdC_INT cdecl = nil;
  ...
  ASN1_item_d2i_bio: function(const it: PASN1_ITEM; &in: PBIO; x: Pointer): Pointer cdecl = nil;
  ASN1_i2d_bio: function(i2d: Pi2d_of_void; &out: PBIO; x: PByte): TIdC_INT cdecl = nil;
  ...
  ASN1_item_i2d_bio: function(const it: PASN1_ITEM; &out: PBIO; x: Pointer): TIdC_INT cdecl = nil;
  ...
  ASN1_mbstring_copy: function(&out: PPASN1_STRING; const &in: PByte; len: TIdC_INT; inform: TIdC_INT; mask: TIdC_ULONG): TIdC_INT cdecl = nil;
  ASN1_mbstring_ncopy: function(&out: PPASN1_STRING; const &in: PByte; len: TIdC_INT; inform: TIdC_INT; mask: TIdC_ULONG; minsize: TIdC_LONG; maxsize: TIdC_LONG): TIdC_INT cdecl = nil;

  ASN1_STRING_set_by_NID: function(&out: PPASN1_STRING; const &in: PByte; inlen: TIdC_INT; inform: TIdC_INT; nid: TIdC_INT): PASN1_STRING cdecl = nil;
  ...
  ASN1_item_d2i: function(val: PPASN1_VALUE; const &in: PPByte; len: TIdC_LONG; const it: PASN1_ITEM): PASN1_VALUE cdecl = nil;
  ASN1_item_i2d: function(val: PASN1_VALUE; &out: PPByte; const it: PASN1_ITEM): TIdC_INT cdecl = nil;
  ASN1_item_ndef_i2d: function(val: PASN1_VALUE; &out: PPByte; const it: PASN1_ITEM): TIdC_INT cdecl = nil;
  ...
  i2d_ASN1_bio_stream: function(&out: PBIO; val: PASN1_VALUE; &in: PBIO; flags: TIdC_INT; const it: PASN1_ITEM): TIdC_INT cdecl = nil;
  PEM_write_bio_ASN1_stream: function(&out: PBIO; val: PASN1_VALUE; &in: PBIO; flags: TIdC_INT; const hdr: PAnsiChar; const it: PASN1_ITEM): TIdC_INT cdecl = nil;
  ...
  SMIME_crlf_copy: function(&in: PBIO; &out: PBIO; flags: TIdC_INT): TIdC_INT cdecl = nil;
  SMIME_text: function(&in: PBIO; &out: PBIO): TIdC_INT cdecl = nil;
