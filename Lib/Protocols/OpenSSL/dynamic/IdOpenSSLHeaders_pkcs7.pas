...
var
  ...
  PKCS7_ISSUER_AND_SERIAL_digest: function(data: PPKCS7_ISSUER_AND_SERIAL; const &type: PEVP_MD; md: PByte; len: PIdC_UINT): TIdC_INT cdecl = nil;
  ...
  i2d_PKCS7_bio_stream: function(&out: PBIO; p7: PPKCS7; &in: PBIO; flags: TIdC_INT): TIdC_INT cdecl = nil;
  PEM_write_bio_PKCS7_stream: function(&out: PBIO; p7: PPKCS7; &in: PBIO; flags: TIdC_INT): TIdC_INT cdecl = nil;
...
//  function PKCS7_print_ctx(&out: PBIO; const x: PPKCS7; indent: TIdC_INT; const pctx: PASN1_PCTX): TIdC_INT;
  ...
  PKCS7_set_type: function(p7: PPKCS7; &type: TIdC_INT): TIdC_INT cdecl = nil;
  PKCS7_set0_type_other: function(p7: PPKCS7; &type: TIdC_INT; other: PASN1_TYPE): TIdC_INT cdecl = nil;
...
//  function PKCS7_get_signer_info(p7: PPKCS7): PSTACK_OF_PKCS7_SIGNER_INFO;
  ...
  PKCS7_add_signed_attribute: function(p7si: PPKCS7_SIGNER_INFO; nid: TIdC_INT; &type: TIdC_INT; data: Pointer): TIdC_INT cdecl = nil;
