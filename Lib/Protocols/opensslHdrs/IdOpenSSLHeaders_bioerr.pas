  (* This unit was generated using the script genOpenSSLHdrs.sh from the source file IdOpenSSLHeaders_bioerr.h2pas
     It should not be modified directly. All changes should be made to IdOpenSSLHeaders_bioerr.h2pas
     and this file regenerated. IdOpenSSLHeaders_bioerr.h2pas is distributed with the full Indy
     Distribution.
   *)
...
{$ELSE}
  function ERR_load_BIO_strings: TIdC_INT cdecl; external {$IFNDEF OPENSSL_USE_STATIC_LIBRARY}CLibCrypto{$ENDIF}{$IFDEF OPENSSL_USE_DELAYED_LOADING} delayed{$ENDIF};
...
begin
  ERR_load_BIO_strings := LoadFunction('ERR_load_BIO_strings',AFailed);
end;
