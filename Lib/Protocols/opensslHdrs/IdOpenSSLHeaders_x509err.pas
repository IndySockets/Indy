  (* This unit was generated using the script genOpenSSLHdrs.sh from the source file IdOpenSSLHeaders_x509err.h2pas
     It should not be modified directly. All changes should be made to IdOpenSSLHeaders_x509err.h2pas
     and this file regenerated. IdOpenSSLHeaders_x509err.h2pas is distributed with the full Indy
     Distribution.
   *)
...
begin
  ERR_load_X509_strings := LoadFunction('ERR_load_X509_strings',AFailed);
end;
