  (* This unit was generated using the script genOpenSSLHdrs.sh from the source file IdOpenSSLHeaders_obj_mac.h2pas
     It should not be modified directly. All changes should be made to IdOpenSSLHeaders_obj_mac.h2pas
     and this file regenerated. IdOpenSSLHeaders_obj_mac.h2pas is distributed with the full Indy
     Distribution.
   *)
