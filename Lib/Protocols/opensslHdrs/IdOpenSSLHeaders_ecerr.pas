  (* This unit was generated using the script genOpenSSLHdrs.sh from the source file IdOpenSSLHeaders_ecerr.h2pas
     It should not be modified directly. All changes should be made to IdOpenSSLHeaders_ecerr.h2pas
     and this file regenerated. IdOpenSSLHeaders_ecerr.h2pas is distributed with the full Indy
     Distribution.
   *)
...
{$ELSE}
  function ERR_load_EC_strings: TIdC_INT cdecl; external {$IFNDEF OPENSSL_USE_STATIC_LIBRARY}CLibCrypto{$ENDIF}{$IFDEF OPENSSL_USE_DELAYED_LOADING} delayed{$ENDIF};
