  (* This unit was generated using the script genOpenSSLHdrs.sh from the source file IdOpenSSLHeaders_rsaerr.h2pas
     It should not be modified directly. All changes should be made to IdOpenSSLHeaders_rsaerr.h2pas
     and this file regenerated. IdOpenSSLHeaders_rsaerr.h2pas is distributed with the full Indy
     Distribution.
   *)
...
{$ELSE}
  function ERR_load_RSA_strings: TIdC_INT cdecl; external {$IFNDEF OPENSSL_USE_STATIC_LIBRARY}CLibCrypto{$ENDIF}{$IFDEF OPENSSL_USE_DELAYED_LOADING} delayed{$ENDIF};
