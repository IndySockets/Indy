...
//* Used by GOST key encryption in TLS */
  ...
  {$EXTERNALSYM EVP_F_DO_EVP_ENC_ENGINE_FULL}
  EVP_F_DO_EVP_ENC_ENGINE_FULL = 141;
  {$EXTERNALSYM EVP_F_DO_EVP_MD_ENGINE}
  EVP_F_DO_EVP_MD_ENGINE = 139;
  {$EXTERNALSYM EVP_F_DO_EVP_MD_ENGINE_FULL}
  ...
  {$EXTERNALSYM EVP_F_EVP_CIPHERINIT}
  ...
  {$EXTERNALSYM EVP_F_EVP_DIGESTINIT}
...
//* Stats */
  ...
  {$EXTERNALSYM SSL_F_SSL3_SETUP_BUFFERS}
