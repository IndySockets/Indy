...
:preparefolders
if not exist ..\C37\*.* md ..\C37 > nul
if not exist ..\C37\ZLib\*.* md ..\C37\ZLib > nul
if not exist ..\C37\ZLib\i386-Win32-ZLib\*.* md ..\C37\ZLib\i386-Win32-ZLib > nul
if not exist ..\C37\ZLib\x86_64-Win64-ZLib\*.* md ..\C37\ZLib\x86_64-Win64-ZLib > nul
if not exist ..\C37\%IndyPlatform% md ..\C37\%IndyPlatform% > nul
if not exist ..\C37\%IndyPlatform%\%IndyConfig% md ..\C37\%IndyPlatform%\%IndyConfig% > nul

if exist ..\C37\*.* call clean.bat ..\C37\
...
:indysystem
cd System
copy IndySystem370.dpk ..\..\C37 > nul
copy IndySystem370.dproj ..\..\C37 > nul
copy *.res ..\..\C37 > nul
copy *.pas ..\..\C37 > nul
copy *.inc ..\..\C37 > nul
copy *.ico ..\..\C37 > nul
...
msbuild IndySystem370.dproj /t:Rebuild /p:Config=%IndyConfig%;Platform=%IndyPlatform%;DCC_Define="BCB"
...
copy *IndyCore370.dpk ..\..\C37 > nul
copy *IndyCore370.dproj ..\..\C37 > nul
copy *.res ..\..\C37 > nul
copy *.pas ..\..\C37 > nul
copy *.dcr ..\..\C37 > nul
copy *.inc ..\..\C37 > nul
...
msbuild IndyCore370.dproj /t:Rebuild /p:Config=%IndyConfig%;Platform=%IndyPlatform%;DCC_Define="BCB"
if errorlevel 1 goto enderror

REM design time is for Win32 only
if not "%IndyPlatform%" == "Win32" goto indyprotocols

msbuild dclIndyCore370.dproj /t:Rebuild /p:Config=%IndyConfig%;Platform=%IndyPlatform%;DCC_Define="BCB"
if errorlevel 1 goto enderror
...
copy zlib\i386-Win32-ZLib\*.obj ..\..\C37\ZLib\i386-Win32-ZLib > nul
copy zlib\x86_64-Win64-ZLib\*.obj ..\..\C37\ZLib\x86_64-Win64-ZLib > nul
copy *IndyProtocols370.dpk ..\..\C37 > nul
copy *IndyProtocols370.dproj ..\..\C37 > nul
copy *.res ..\..\C37 > nul
copy *.pas ..\..\C37 > nul
copy *.dcr ..\..\C37 > nul
copy *.inc ..\..\C37 > nul
...
msbuild IndyProtocols370.dproj /t:Rebuild /p:Config=%IndyConfig%;Platform=%IndyPlatform%;DCC_Define="BCB"
if errorlevel 1 goto enderror

REM design time is for Win32 only
if not "%IndyPlatform%" == "Win32" goto copygenerated

msbuild dclIndyProtocols370.dproj /t:Rebuild /p:Config=%IndyConfig%;Platform=%IndyPlatform%;DCC_Define="BCB"
if errorlevel 1 goto enderror
...
copy indysystem370.res %IndyPlatform%\%IndyConfig%
copy indycore370.res %IndyPlatform%\%IndyConfig%
copy indyprotocols370.res %IndyPlatform%\%IndyConfig%
