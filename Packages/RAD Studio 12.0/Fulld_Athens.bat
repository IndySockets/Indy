...
REM
REM Example: FullD29               -> will build Release, Win32
REM Example: FullD29 Debug         -> will build Debug, Win32
REM Example: FullD29 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD29
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD29%)==() goto enderror

REM Set up the environment
call %NDD29%\bin\rsvars.bat
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\Output\D29\%IndyPlatform%\%IndyConfig%

if not exist ..\..\Output\D29\*.* md ..\..\Output\D29 > nul
if not exist ..\..\Output\D29\%IndyPlatform% md ..\..\Output\D29\%IndyPlatform% > nul
if not exist ..\..\Output\D29\%IndyPlatform%\%IndyConfig% md ..\..\Output\D29\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\Output\D29\*.* call "%~dp0..\Clean.bat" ..\..\Output\D29\
...
:endnocompiler
echo Delphi 12 Athens Compiler Not Present!
goto endok
