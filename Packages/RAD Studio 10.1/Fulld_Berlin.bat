...
REM
REM Example: FullD24               -> will build Release, Win32
REM Example: FullD24 Debug         -> will build Debug, Win32
REM Example: FullD24 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD24
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD24%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\Output\D24\%IndyPlatform%\%IndyConfig%

if not exist ..\..\Output\D24\*.* md ..\..\Output\D24 > nul
if not exist ..\..\Output\D24\%IndyPlatform% md ..\..\Output\D24\%IndyPlatform% > nul
if not exist ..\..\Output\D24\%IndyPlatform%\%IndyConfig% md ..\..\Output\D24\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\Output\D24\*.* call "%~dp0..\Clean.bat" ..\..\Output\D24\
...
:endnocompiler
echo Delphi 10.1 Berlin Compiler Not Present!
goto endok
