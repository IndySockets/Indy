...
REM
REM Example: FullD37               -> will build Release, Win32
REM Example: FullD37 Debug         -> will build Debug, Win32
REM Example: FullD37 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD37
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD37%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\Output\D37\%IndyPlatform%\%IndyConfig%

if not exist ..\..\Output\D37\*.* md ..\..\Output\D37 > nul
if not exist ..\..\Output\D37\%IndyPlatform% md ..\..\Output\D37\%IndyPlatform% > nul
if not exist ..\..\Output\D37\%IndyPlatform%\%IndyConfig% md ..\..\Output\D37\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\Output\D37\*.* call "%~dp0..\Clean.bat" ..\..\Output\D37\
...
:endnocompiler
echo Delphi 13 Florence Compiler Not Present!
goto endok
