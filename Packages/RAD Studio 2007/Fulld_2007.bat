...
REM
REM Example: FullD11               -> will build Release, Win32
REM Example: FullD11 Debug         -> will build Debug, Win32
REM Example: FullD11 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\Output\D11\%IndyPlatform%\%IndyConfig%

if not exist ..\..\Output\D11\*.* md ..\..\Output\D11 > nul
if not exist ..\..\Output\D11\%IndyPlatform% md ..\..\Output\D11\%IndyPlatform% > nul
if not exist ..\..\Output\D11\%IndyPlatform%\%IndyConfig% md ..\..\Output\D11\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\Output\D11\*.* call "%~dp0..\Clean.bat" ..\..\Output\D11\
...
:endnocompiler
echo Delphi 2007 Compiler Not Present!
goto endok
