...
ECHO ****************
pushd System
%DCC32% /U..\..\Lib /I..\..\Lib IndySystem.dpk %OPTIONS% %EXEOUTPUTDIRS% %OTHEROUTPUTDIRS% /$%SWITCHES% %2 %3 %4
...
ECHO **************
pushd Core
%DCC32% /U..\..\Lib /I..\..\Lib IndyCore.dpk %OPTIONS% %EXEOUTPUTDIRS% %OTHEROUTPUTDIRS% /$%SWITCHES% %2 %3 %4
if errorlevel 1 goto enderror
%DCC32% /U..\..\Lib /I..\..\Lib dclIndyCore.dpk %OPTIONS% %EXEOUTPUTDIRS% %OTHEROUTPUTDIRS% /$%SWITCHES% %2 %3 %4
if errorlevel 1 goto enderror
...
ECHO ************************
rem %NDD10%\Bin\dcc32.exe -DBCB -B -M -JPHNE -N..\..\Output\D100 /U..\..\Output\D100 -H -W -Z ..\..\Lib\Protocols\IdCompressionIntercept.pas -$d-l-
rem if errorlevel 1 goto enderror

%DCC32% /U..\..\Lib /I..\..\Lib IndyProtocols.dpk %OPTIONS% %EXEOUTPUTDIRS% %OTHEROUTPUTDIRS% /$%SWITCHES% %2 %3 %4
if errorlevel 1 goto enderror
%DCC32% /U..\..\Lib /I..\..\Lib dclIndyProtocols.dpk %OPTIONS% %EXEOUTPUTDIRS% %OTHEROUTPUTDIRS% /$%SWITCHES% %2 %3 %4
if errorlevel 1 goto enderror
