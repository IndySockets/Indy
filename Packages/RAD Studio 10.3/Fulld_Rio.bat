...
REM
REM Example: FullD26               -> will build Release, Win32
REM Example: FullD26 Debug         -> will build Debug, Win32
REM Example: FullD26 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD26
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD26%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\Output\D26\%IndyPlatform%\%IndyConfig%

if not exist ..\..\Output\D26\*.* md ..\..\Output\D26 > nul
if not exist ..\..\Output\D26\%IndyPlatform% md ..\..\Output\D26\%IndyPlatform% > nul
if not exist ..\..\Output\D26\%IndyPlatform%\%IndyConfig% md ..\..\Output\D26\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\Output\D26\*.* call "%~dp0..\Clean.bat" ..\..\Output\D26\
...
:endnocompiler
echo Delphi 10.3 Rio Compiler Not Present!
goto endok
