...
REM
REM Example: FullD20               -> will build Release, Win32
REM Example: FullD20 Debug         -> will build Debug, Win32
REM Example: FullD20 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\Output\D20\%IndyPlatform%\%IndyConfig%

if not exist ..\..\Output\D20\*.* md ..\..\Output\D20 > nul
if not exist ..\..\Output\D20\%IndyPlatform% md ..\..\Output\D20\%IndyPlatform% > nul
if not exist ..\..\Output\D20\%IndyPlatform%\%IndyConfig% md ..\..\Output\D20\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\Output\D20\*.* call "%~dp0..\Clean.bat" ..\..\Output\D20\
...
:endnocompiler
echo Delphi XE6 Compiler Not Present!
goto endok
