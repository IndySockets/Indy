...
REM
REM Example: FullD14               -> will build Release, Win32
REM Example: FullD14 Debug         -> will build Debug, Win32
REM Example: FullD14 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
"%~dp0..\Computil.exe" SetupD14
if exist setenv.bat call setenv.bat
if exist setenv.bat del setenv.bat > nul

if (%NDD14%)==() goto enderror
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\Output\D14\%IndyPlatform%\%IndyConfig%

if not exist ..\..\Output\D14\*.* md ..\..\Output\D14 > nul
if not exist ..\..\Output\D14\%IndyPlatform% md ..\..\Output\D14\%IndyPlatform% > nul
if not exist ..\..\Output\D14\%IndyPlatform%\%IndyConfig% md ..\..\Output\D14\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\Output\D14\*.* call "%~dp0..\Clean.bat" ..\..\Output\D14\
...
:endnocompiler
echo Delphi 2010 Compiler Not Present!
goto endok
