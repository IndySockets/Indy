...
REM ****************************************************************************
REM  C++Builder 15 build for Indy (packages relocated; source resolves via ..\..\Lib).
REM  Build runs in the Output\C15 temp dir so the dpk's ..\..\Lib paths resolve.
REM ****************************************************************************
...
copy ..\..\Lib\Protocols\zlib\*.obj ..\..\Output\C15 > nul
cd ..\..\Output\C15
