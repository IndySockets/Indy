...
REM
REM Example: FullD16               -> will build Release, Win32
REM Example: FullD16 Debug         -> will build Debug, Win32
REM Example: FullD16 Release Win64 -> will build Release, Win64 (if available)
REM 
REM ****************************************************************************
...
:preparefolders
SET IndyPkg=%~dp0.
SET IndyBin=%~dp0..\..\Output\D16\%IndyPlatform%\%IndyConfig%

if not exist ..\..\Output\D16\*.* md ..\..\Output\D16 > nul
if not exist ..\..\Output\D16\%IndyPlatform% md ..\..\Output\D16\%IndyPlatform% > nul
if not exist ..\..\Output\D16\%IndyPlatform%\%IndyConfig% md ..\..\Output\D16\%IndyPlatform%\%IndyConfig% > nul

if exist ..\..\Output\D16\*.* call "%~dp0..\Clean.bat" ..\..\Output\D16\
...
:endnocompiler
echo Delphi XE2 Compiler Not Present!
goto endok
