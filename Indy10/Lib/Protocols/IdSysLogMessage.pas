...
uses
  IdGlobal, IdGlobalProtocols, SysUtils, Classes, IdBaseComponent;
...
uses
  IdAssignedNumbers, IdExceptionCore, IdResourceStringsProtocols, IdStack, IdStackConsts, IdUDPClient;
