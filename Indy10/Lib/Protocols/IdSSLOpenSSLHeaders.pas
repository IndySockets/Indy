...
W:\openssl-0.9.8g>ms\do_win64a

W:\openssl-0.9.8g>perl util\mkfiles.pl  1>MINFO

W:\openssl-0.9.8g>perl ms\uplink.pl win64a  1>ms\uptable.asm

W:\openssl-0.9.8g>ml64 -c -Foms\uptable.obj ms\uptable.asm
Microsoft (R) Macro Assembler (AMD64) Version 8.00.40310.39
Copyright (C) Microsoft Corporation.  All rights reserved.

 Assembling: ms\uptable.asm

W:\openssl-0.9.8g>perl util\mk1mf.pl no-asm VC-WIN64A  1>ms\nt.mak

W:\openssl-0.9.8g>perl util\mk1mf.pl dll no-asm VC-WIN64A  1>ms\ntdll.mak

W:\openssl-0.9.8g>perl util\mkdef.pl 32 libeay  1>ms\libeay32.def

W:\openssl-0.9.8g>perl util\mkdef.pl 32 ssleay  1>ms\ssleay32.def

cl /Fotmp32dll\prime.obj -DMONOLITH -Iinc32 -Itmp32dll /MD /Ox /W3 /Gs0/GF 
/Gy /nologo -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -DDSO_WIN32 
-DOPENSSL_SYSNAME_WIN32 -DOPENSSL_SYSNAME_WINNT -DUNICODE 
-D_UNICODE -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE 
-DOPENSSL_USE_APPLINK -I. /Fdout32dll -DOPENSSL_NO_CAME
LLIA -DOPENSSL_NO_SEED -DOPENSSL_NO_RC5 -DOPENSSL_NO_MDC2 -DOPENSSL_NO_TLSEXT 
-DOPENSSL_NO_KRB5 -DOPENSSL_NO_DYNAMIC_ENGINE  -c .\apps\prime.c prime.c
}
...
//* Reason codes. */
  ...
  OPENSSL_OPENSSL_VERSION_NUMBER = $0090807f;
{$IFDEF OPENSSL_FIPS}
  OPENSSL_OPENSSL_VERSION_TEXT = 'OpenSSL 0.9.8g-fips 19 Oct 2007';{Do not localize}
{$ELSE}
  OPENSSL_OPENSSL_VERSION_TEXT = 'OpenSSL 0.9.8g 19 Oct 2007';{Do not localize}
{$ENDIF}
...
const
  ...
  fn_CONF_set_default_method = 'CONF_set_default_method'; {Do not localize}
  fn_CONF_set_nconf = 'CONF_set_nconf'; {Do not localize}
  fn_CONF_load = 'CONF_load'; {Do not localize}
{$IFNDEF OPENSSL_NO_FP_API}
  fn_CONF_load_fp = 'CONF_load_fp'; {Do not localize}
{$ENDIF}
  fn_CONF_load_bio = 'CONF_load_bio'; {Do not localize}
  fn_CONF_get_section = 'CONF_get_section'; {Do not localize}
  fn_CONF_get_string = 'CONF_get_string'; {Do not localize}
  fn_CONF_get_number = 'CONF_get_number'; {Do not localize}
  fn_CONF_free = 'CONF_free'; {Do not localize}
  fn_CONF_dump_fp = 'CONF_dump_fp'; {Do not localize}
  fn_CONF_dump_bio = 'CONF_dump_bio'; {Do not localize}
  fn_NCONF_new = 'NCONF_new'; {Do not localize}
  fn_NCONF_default = 'NCONF_default'; {Do not localize}
  fn_NCONF_WIN32 = 'NCONF_WIN32'; {Do not localize}
{$IFDEF OMITTHIS} //* Just to give you an idea of what I have in mind */
  fn_NCONF_XML = 'NCONF_XML''; {Do not localize}
{$ENDIF}
  fn_NCONF_free = 'NCONF_free'; {Do not localize}
  fn_NCONF_free_data = 'NCONF_free_data'; {Do not localize}

  fn_NCONF_load = 'NCONF_load'; {Do not localize}
{$IFNDEF OPENSSL_NO_FP_API}
  fn_NCONF_load_fp = 'NCONF_load_fp'; {Do not localize}
{$ENDIF}
  fn_NCONF_load_bio = 'NCONF_load_bio'; {Do not localize}
  fn_NCONF_get_section = 'NCONF_get_section'; {Do not localize}
  fn_NCONF_get_string = 'NCONF_get_string'; {Do not localize}
  fn_NCONF_get_number_e = 'NCONF_get_number_e'; {Do not localize}
  fn_NCONF_dump_fp = 'NCONF_dump_fp'; {Do not localize}
  fn_NCONF_dump_bio = 'NCONF_dump_bio'; {Do not localize}
  fn_CONF_modules_load = 'CONF_modules_load'; {Do not localize}
  fn_CONF_modules_load_file = 'CONF_modules_load_file'; {Do not localize}
  fn_CONF_modules_unload = 'CONF_modules_unload'; {Do not localize}
  fn_CONF_modules_finish = 'CONF_modules_finish'; {Do not localize}
  fn_CONF_modules_free = 'CONF_modules_free'; {Do not localize}
  fn_CONF_module_add = 'CONF_module_add'; {Do not localize}

  fn_CONF_imodule_get_name = 'CONF_imodule_get_name'; {Do not localize}
  fn_CONF_imodule_get_value = 'CONF_imodule_get_value'; {Do not localize}
  fn_CONF_imodule_get_usr_data = 'CONF_imodule_get_usr_data'; {Do not localize}
  fn_CONF_imodule_set_usr_data = 'CONF_imodule_set_usr_data'; {Do not localize}
  fn_CONF_imodule_get_module = 'CONF_imodule_get_module'; {Do not localize}
  fn_CONF_imodule_get_flags = 'CONF_imodule_get_flags'; {Do not localize}
  fn_CONF_imodule_set_flags = 'CONF_imodule_set_flags'; {Do not localize}
  fn_CONF_module_get_usr_data = 'CONF_module_get_usr_data'; {Do not localize}
  fn_CONF_module_set_usr_data = 'CONF_module_set_usr_data'; {Do not localize}

  fn_CONF_get1_default_config_file = 'CONF_get1_default_config_file'; {Do not localize}

  fn_CONF_parse_list = 'CONF_parse_list';

  fn_OPENSSL_load_builtin_modules = 'OPENSSL_load_builtin_modules'; {Do not localize}
  fn_ERR_load_CONF_strings = 'ERR_load_CONF_strings'; {Do not localize}
  ...
  fn_SSL_set_SSL_CTX = 'SSL_set_SSL_CTX';  {Do not localize}
