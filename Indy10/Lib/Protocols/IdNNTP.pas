...
type
  ...
  public
    ...
    function GetArticle(AMsgNo: Integer; AMsg: TStrings): Boolean; overload;
    ...
    function GetBody(AMsgNo: Integer; AMsg: TStrings): Boolean; overload;
    ...
    function GetHeader(AMsgNo: Integer; AMsg: TStrings): Boolean; overload;
