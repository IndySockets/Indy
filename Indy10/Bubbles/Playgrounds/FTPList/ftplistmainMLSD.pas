...
{**********************************************************************}
{}
{ $Log:  16040: ftplistmainMLSD.pas 
{
{   Rev 1.0    2/13/2003 03:04:14 PM  JPMugaas
  ...
  try
    ...
    try
      ...
      begin
        ...
        LDirectoryListing.ListFormat := flfMLS;
        LDirectoryListing.LoadMList(s);
        d.Assign(s);
        d.Add('==============================');
